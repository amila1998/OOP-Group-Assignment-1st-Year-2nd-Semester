...
<title>Content Creater Registration</title>
<header>
...
<br><br>
    	<center><h1 class="Ttxtstyle">Become a Content Creator</h1></center>
...
<section style="width:100%">
	<div id="formStyle1">
		...
		<fieldset>
			...
			<input type="text" id="companyName2" name="companyNam2e" required>
